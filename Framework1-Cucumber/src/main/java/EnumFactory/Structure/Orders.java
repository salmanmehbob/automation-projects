...
public enum Orders {
    ...
    XPATH_Automation_Product("//input[@id='j_idt27:orderDetails:titleTable:1:chkDefaultTitleProduct']"),
    ...
    //XPATH_Order_Search("//img[@class='enterOnSearchBtn active']/parent::*"),
    XPATH_Order_Search("//img[@alt='Search Order']"),
    XPATH_Test("//input[@id='header:j_idt25:txtSearchValue']");

    private String pageVariables;

    private Orders(String pageVariables) {
